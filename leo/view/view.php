...
<html>
    ...
    <ul>
        <li style="display:inline; margin-right:1em; padding: 3px; border:2px black solid"><a href = index.php?action=readAll&controller=utilisateur>Les utilisateur</a></li>
        ...
        <li style="display:inline; margin-right:1em; padding: 3px; border:2px black solid"><a href="index.php?action=connect&controller=utilisateur">Connexion</a></li>
        ...
        <li style="display:inline; margin-right:1em; padding: 3px; border:2px black solid"><a href="index.php?action=create&controller=utilisateur">Inscription</a></li>
